...
router.get("/batch/:symbols", (req, res) => {
  axios
    .get(
      `https://${process.env.NODE_ENV === "production" ? "cloud" : "sandbox"}.iexapis.com/stable/stock/market/batch?symbols=${req.params.symbols
...
router.get("/lookup/:symbol", (req, res) => {
  axios
    .get(
      `https://${process.env.NODE_ENV === "production" ? "cloud" : "sandbox"
      }.iexapis.com/stable/stock/${req.params.symbol
...
router.get("/chart/:symbol/:range", (req, res) => {
  ...
  axios
    .get(
      `https://sandbox.iexapis.com/stable/stock/${symbol}/chart/${rangeSubUrl[range]
