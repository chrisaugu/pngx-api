...
function getCompanies(options) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield fetcher(`/companies`);
        return res;
    });
}
// /**
...
function getTicker(symbol, options) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield fetcher(`/tickers/${symbol}`, options);
        return res.ticker;
    });
}
...
export { OLD_QUOTES, QUOTES, fetcher, getCompanies, getHistoricals, getStock, getStocks, getTicker, getTickers };
