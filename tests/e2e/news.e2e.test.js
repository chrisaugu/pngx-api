...
describe('News E2E', () => {
    ...
    describe('News Source Management Flow', () => {
        it('should complete full CRUD flow for news sources', async () => {
            ...
            const sourceId = createResponse.body._id || getAllResponse.body.data[0]._id;

            // Read specific
            const getOneResponse = await request(app)
                .get(`/api/v2/news/sources/${sourceId}`);
            ...
            const deleteResponse = await request(app)
                .delete(`/api/v2/news/sources/${sourceId}`);
